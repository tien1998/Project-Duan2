<%-- 
    Document   : loaihinh
    Created on : Dec 1, 2018, 3:06:40 PM
    Author     : QUOCTRONG
--%>
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-panel">
                ...
                <%@include file="loaihinh-content.jsp" %>
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        ...
                        <p class="copyright pull-right">
                            &copy; <script>document.write(new Date().getFullYear())</script> <a href="dashboard.htm">QUẢN LÝ NHÂN VIÊN</a>
                        </p>
                    </div>
                </footer>
